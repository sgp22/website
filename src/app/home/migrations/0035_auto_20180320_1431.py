# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2018-03-20 14:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='tokenCategory',
            field=models.CharField(blank=True, max_length=255, verbose_name='Token Category'),
        ),
        migrations.AddField(
        ...
        migrations.AlterField(
            ...
            name='body',
            field=wagtail.wagtailcore.fields.StreamField((('heading', wagtail.wagtailcore.blocks.CharBlock(classname='full title')), ('image', home.models.APIImageChooserBlock()), ('table', wagtail.contrib.table_block.blocks.TableBlock()), ('markdown', home.models.APIMarkDownBlock()), ('tokenCategory', wagtail.wagtailcore.blocks.CharBlock())), blank=True, null=True),
        ),
        migrations.AlterField(
            model_name='elementspage',
            name='modifiers',
